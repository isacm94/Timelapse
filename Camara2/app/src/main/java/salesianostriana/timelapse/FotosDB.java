...
public class FotosDB {
    ...
    static final String TAG = "FotosDB";
    ...
    public long insert(Foto foto) {
        ...
        columnas.put(PATH, foto.getPath());
        columnas.put(FECHA, foto.getFecha());
     ...
     */
    public FotosDB openWrite() throws SQLException {
     ...
     */
    public FotosDB openRead() throws SQLException {
        // this.mDbHelper = new DatabaseHelper(this.mCtx);
